...
var Stream     = require('hummingbird-service').Stream;
var Responder  = require('./wordpress_responder.js');
...
WordpressStream.prototype.start = function() {
  winston.warn(this._service, 'Stream:', 'starting...');
...
WordpressStream.prototype.stop = function() {
  winston.warn(this._service, 'Stream:', 'stopping...');
...
WordpressStream.prototype.restart = function() {
  winston.warn(this._service, 'Stream:', 'Restart initiated');
  this.stop();
